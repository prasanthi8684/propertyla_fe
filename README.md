...
NEXT_PUBLIC_API_URL=http://159.223.92.101:3008/api
...
The application connects to a backend API at `http://159.223.92.101:3008/api` by default. The API client is configured in `src/config/axios.ts` with:
