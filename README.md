...
NEXT_PUBLIC_API_URL=http://168.144.107.130:3008/api
...
The application connects to a backend API at `http://168.144.107.130:3008/api` by default. The API client is configured in `src/config/axios.ts` with:
