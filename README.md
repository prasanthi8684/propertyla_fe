...
NEXT_PUBLIC_API_URL=http://167.172.80.211:3008/api
...
The application connects to a backend API at `http://167.172.80.211:3008/api` by default. The API client is configured in `src/config/axios.ts` with:
